...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220817211318_AddFlightTables")]
    partial class AddFlightTables
    {
            ...
            modelBuilder.Entity("T.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 79, DateTimeKind.Local).AddTicks(186));
            ...
            modelBuilder.Entity("T.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 79, DateTimeKind.Local).AddTicks(2203));
            ...
            modelBuilder.Entity("T.Domain.Comments.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 79, DateTimeKind.Local).AddTicks(4347));
            ...
            modelBuilder.Entity("T.Domain.Common.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 79, DateTimeKind.Local).AddTicks(6526));
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 79, DateTimeKind.Local).AddTicks(9130));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 80, DateTimeKind.Local).AddTicks(1459));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 80, DateTimeKind.Local).AddTicks(3769));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 80, DateTimeKind.Local).AddTicks(5982));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 80, DateTimeKind.Local).AddTicks(8854));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 81, DateTimeKind.Local).AddTicks(698));
            ...
            modelBuilder.Entity("T.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 81, DateTimeKind.Local).AddTicks(2958));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 81, DateTimeKind.Local).AddTicks(5900));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Room", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 18, 1, 43, 18, 82, DateTimeKind.Local).AddTicks(74));
