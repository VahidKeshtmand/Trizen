...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220803221155_AddRoomsTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T.Domain.Common.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 876, DateTimeKind.Local).AddTicks(904));
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 876, DateTimeKind.Local).AddTicks(6770));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 877, DateTimeKind.Local).AddTicks(1197));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 877, DateTimeKind.Local).AddTicks(5551));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 877, DateTimeKind.Local).AddTicks(9703));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 878, DateTimeKind.Local).AddTicks(4782));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 878, DateTimeKind.Local).AddTicks(8809));
            ...
            modelBuilder.Entity("T.Domain.Common.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("T.Domain.Hotels.AmenityHotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 879, DateTimeKind.Local).AddTicks(4134));
            ...
            modelBuilder.Entity("T.Domain.Hotels.AmenityRoom", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 879, DateTimeKind.Local).AddTicks(9200));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 880, DateTimeKind.Local).AddTicks(5171));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Room", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 881, DateTimeKind.Local).AddTicks(4382));
            ...
            modelBuilder.Entity("T.Domain.Hotels.ServiceRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 2, 41, 54, 882, DateTimeKind.Local).AddTicks(158));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.HasOne("T.Domain.Hotels.Room", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("T.Domain.Hotels.ServiceRoom", b =>
                {
                    b.HasOne("T.Domain.Hotels.Room", "Room")
                        .WithMany("ServiceRoom")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("T.Domain.Common.Service", "Service")
                        .WithMany("ServiceRoom")
