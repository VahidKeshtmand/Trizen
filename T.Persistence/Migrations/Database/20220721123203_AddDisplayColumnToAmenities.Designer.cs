...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220721123203_AddDisplayColumnToAmenities")]
    partial class AddDisplayColumnToAmenities
    {
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 666, DateTimeKind.Local).AddTicks(4111));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 666, DateTimeKind.Local).AddTicks(6316));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 666, DateTimeKind.Local).AddTicks(8605));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 667, DateTimeKind.Local).AddTicks(617));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 667, DateTimeKind.Local).AddTicks(2606));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 667, DateTimeKind.Local).AddTicks(5654));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 21, 17, 2, 2, 667, DateTimeKind.Local).AddTicks(8034));
