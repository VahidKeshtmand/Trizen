...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220828142539_AddBooking")]
            ...
            modelBuilder.Entity("T.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 739, DateTimeKind.Local).AddTicks(3719));
            ...
            modelBuilder.Entity("T.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 739, DateTimeKind.Local).AddTicks(5854));
            ...
            modelBuilder.Entity("T.Domain.Comments.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 739, DateTimeKind.Local).AddTicks(8248));
            ...
            modelBuilder.Entity("T.Domain.Common.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 740, DateTimeKind.Local).AddTicks(496));
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 740, DateTimeKind.Local).AddTicks(3169));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 740, DateTimeKind.Local).AddTicks(5346));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 740, DateTimeKind.Local).AddTicks(7263));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 740, DateTimeKind.Local).AddTicks(9781));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 741, DateTimeKind.Local).AddTicks(2925));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 741, DateTimeKind.Local).AddTicks(4834));
            ...
            modelBuilder.Entity("T.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 741, DateTimeKind.Local).AddTicks(7449));
            ...
            modelBuilder.Entity("T.Domain.Flights.AirlineCompany", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 742, DateTimeKind.Local).AddTicks(460));
            ...
            modelBuilder.Entity("T.Domain.Flights.Flight", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 742, DateTimeKind.Local).AddTicks(3493));
            ...
            modelBuilder.Entity("T.Domain.Flights.Seat", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 742, DateTimeKind.Local).AddTicks(7487));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 743, DateTimeKind.Local).AddTicks(585));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Room", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 28, 18, 55, 39, 743, DateTimeKind.Local).AddTicks(5203));
            ...
            modelBuilder.Entity("T.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("T.Domain.Flights.Flight", "Flight")
                        .WithOne("Booking")
                        .HasForeignKey("T.Domain.Bookings.Booking", "FlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
