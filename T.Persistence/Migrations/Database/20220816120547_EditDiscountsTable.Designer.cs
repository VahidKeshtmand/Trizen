...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220816120547_EditDiscountsTable")]
    partial class EditDiscountsTable
    {
            ...
            modelBuilder.Entity("T.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 720, DateTimeKind.Local).AddTicks(4699));
            ...
            modelBuilder.Entity("T.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 720, DateTimeKind.Local).AddTicks(7429));
            ...
            modelBuilder.Entity("T.Domain.Comments.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 721, DateTimeKind.Local).AddTicks(313));
            ...
            modelBuilder.Entity("T.Domain.Common.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 721, DateTimeKind.Local).AddTicks(3221));
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 721, DateTimeKind.Local).AddTicks(5289));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 721, DateTimeKind.Local).AddTicks(6942));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 721, DateTimeKind.Local).AddTicks(8608));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 722, DateTimeKind.Local).AddTicks(96));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 722, DateTimeKind.Local).AddTicks(1742));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 722, DateTimeKind.Local).AddTicks(3333));
            ...
            modelBuilder.Entity("T.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 722, DateTimeKind.Local).AddTicks(5446));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 722, DateTimeKind.Local).AddTicks(8323));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Room", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 16, 16, 35, 46, 723, DateTimeKind.Local).AddTicks(2197));
