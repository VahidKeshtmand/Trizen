...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220718155810_AddHotelsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInforamtion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PersonalJobTitleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonalJobTitleId")
                        .IsUnique();

                    b.ToTable("PersonalInforamtions");
                });

            modelBuilder.Entity("T.Domain.Common.PersonalJobTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PersonalInforamtionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.HasIndex("PersonalInforamtionId")
                        .IsUnique()
                        .HasFilter("[PersonalInforamtionId] IS NOT NULL");
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInforamtion", b =>
                {
                    b.HasOne("T.Domain.Common.PersonalJobTitle", "PersonalJobTitle")
                        .WithOne("PersonalInforamtion")
                        .HasForeignKey("T.Domain.Common.PersonalInforamtion", "PersonalJobTitleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PersonalJobTitle");
                });
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.HasOne("T.Domain.Common.PersonalInforamtion", "PersonalInforamtion")
                        .WithOne("Hotel")
                        .HasForeignKey("T.Domain.Hotels.Hotel", "PersonalInforamtionId");
                    ...
                    b.Navigation("PersonalInforamtion");
                });
