...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220728125300_AddFAQsTable")]
            ...
            modelBuilder.Entity("T.Domain.Common.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 594, DateTimeKind.Local).AddTicks(1824));
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 594, DateTimeKind.Local).AddTicks(4044));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 594, DateTimeKind.Local).AddTicks(6406));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 594, DateTimeKind.Local).AddTicks(8611));
            ...
            modelBuilder.Entity("T.Domain.Common.FAQ", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 595, DateTimeKind.Local).AddTicks(420));
            ...
            modelBuilder.Entity("T.Domain.Common.Image", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 595, DateTimeKind.Local).AddTicks(2616));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 595, DateTimeKind.Local).AddTicks(4478));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 595, DateTimeKind.Local).AddTicks(6780));
            ...
            modelBuilder.Entity("T.Domain.Hotels.AmenityHotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 595, DateTimeKind.Local).AddTicks(9406));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 17, 23, 0, 596, DateTimeKind.Local).AddTicks(2110));
