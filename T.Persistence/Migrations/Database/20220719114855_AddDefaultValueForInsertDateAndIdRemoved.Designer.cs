...
namespace T.Persistence.Migrations.Database
{
    ...
    [Migration("20220719114855_AddDefaultValueForInsertDateAndIdRemoved")]
    partial class AddDefaultValueForInsertDateAndIdRemoved
    {
            ...
            modelBuilder.Entity("T.Domain.Common.Contact", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 324, DateTimeKind.Local).AddTicks(5685));
            ...
            modelBuilder.Entity("T.Domain.Common.Country", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 324, DateTimeKind.Local).AddTicks(7536));
            ...
            modelBuilder.Entity("T.Domain.Common.Currency", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 324, DateTimeKind.Local).AddTicks(9280));
            ...
            modelBuilder.Entity("T.Domain.Common.JobTitle", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 325, DateTimeKind.Local).AddTicks(920));
            ...
            modelBuilder.Entity("T.Domain.Common.PersonalInformation", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 325, DateTimeKind.Local).AddTicks(2804));
                    ...
                    b.ToTable("PersonalInforamtions");
                });
            ...
            modelBuilder.Entity("T.Domain.Hotels.Amenity", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 325, DateTimeKind.Local).AddTicks(4947));
            ...
            modelBuilder.Entity("T.Domain.Hotels.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 19, 16, 18, 55, 325, DateTimeKind.Local).AddTicks(7101));
